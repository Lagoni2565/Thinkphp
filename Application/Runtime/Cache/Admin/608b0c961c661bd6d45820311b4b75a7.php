...
<div class="content">
    ...
    <!-- edit form -->
    <form action="/index.php/Admin/Goods/edit/id/85" method="post" id="tab" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo ($goods["id"]); ?>"></input>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in" id="desc">
                <div class="well">
                    <label>商品简介：</label>
                    <textarea id="ueditor" name="goods_introduce" style="width:100% ; height:300px" ><?php echo ($goods["goods_introduce"]); ?></textarea>
                     
                </div>
            </div>
            <div class="tab-pane fade in" id="attr">
                <div class="well">
                    <label>商品分类(商品类型)：</label>
                    <select name="type_id" class="input-xlarge">
                        <option value="0" >==请选择==</option>
                        <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["type_id"]); ?>" <?php if($vol['type_id'] == $goods['type_id'] ): ?>selected="selected"<?php endif; ?>  > <?php echo ($vol["type_name"]); ?> </option><?php endforeach; endif; else: echo "" ;endif; ?>   
                    </select>
            ...
            <div class="tab-pane fade in" id="pics">
                <div class="well">
                        ...
                        <div>
                        <?php if(is_array($goodspics)): $k = 0; $__LIST__ = $goodspics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><div><img src="<?php echo ($vol["pics_mid"]); ?>"><a pics_id=<?php echo ($vol["id"]); ?> href="javascript:void(0)" class="sub_pic">[-]</a></div><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                </div>
            </div>
