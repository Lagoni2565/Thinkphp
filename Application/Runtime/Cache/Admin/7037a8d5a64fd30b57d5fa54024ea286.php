...
<div class="content">
    ...
    <div class="well">
    <a class="btn btn-primary" onclick="javascript:window.location.href='/index.php/Admin/Auth/add'">新增</a>
        <!-- table -->
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
            <?php if(is_array($auth)): $k = 0; $__LIST__ = $auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><tr class="success">
                    <td><?php echo ($vol["id"]); ?></td>
                    <td><?php echo (str_repeat("--",$vol["level"] * 4)); echo ($vol["auth_name"]); ?></td>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Auth/delete/id/<?php echo ($vol["id"]); ?>'"> 删除 </a>
                    </td>
