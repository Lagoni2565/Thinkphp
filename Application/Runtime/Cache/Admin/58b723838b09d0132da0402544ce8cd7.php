...
<div class="content">
    ...
    <div class="well">
    <a class="btn btn-primary" onclick="javascript:window.location.href='/index.php/Admin/Type/add'">新增</a>
        <!-- table -->
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
            <?php if(is_array($type)): $k = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><tr class="success">
                    <td><?php echo ($vol["type_id"]); ?></td>
                    <td><?php echo ($vol["type_name"]); ?></td>
                    <td>
                        <a href="/index.php/Admin/Type/edit/type_id/<?php echo ($vol["type_id"]); ?>"> 编辑 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Type/delete/type_id/<?php echo ($vol["type_id"]); ?>'"> 删除 </a>
                    </td>
