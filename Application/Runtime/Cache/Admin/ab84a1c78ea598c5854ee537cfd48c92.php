...
<div class="content">
    ...
    <div class="well">
        <!-- add form -->
        <form action="/index.php/Admin/Role/add" method="post" id="tab">
            <label>用户组role_name</label>
            <input type="text" name="role_name" value="" class="input-xlarge">
          <!--   <label>权限id</label>
            <input type="text" name="role_auth_ids" value="" class="input-xlarge">
            <label>权限ac</label>
            <input type="text" name="role_auth_ac" value="" class="input-xlarge"> --><br>
