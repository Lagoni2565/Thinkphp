...
<div class="content">
    <div class="header">
        <h1 class="page-title">商品类型修改</h1>
    </div>

    <div class="well">
        <!-- add form -->
        <form id="tab" action="/index.php/Admin/Type/edit" method="post">
        <input type="hidden" name="type_id" value="<?php echo ($type["type_id"]); ?>"></input>
            <label>类型名称：</label>
            <input type="text" name="type_name" value="<?php echo ($type["type_name"]); ?>" class="input-xlarge">
