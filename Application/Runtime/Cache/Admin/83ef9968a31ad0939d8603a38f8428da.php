    ...
    <div class="well">
        ...
        <form id="tab" action="/index.php/Admin/Attribute/add" method="post">
            ...
            <select name="type_id" class="dfinput">
                ...
                <?php if(is_array($type)): $k = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><option value="<?php echo ($vol["type_id"]); ?>"><?php echo ($vol["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
