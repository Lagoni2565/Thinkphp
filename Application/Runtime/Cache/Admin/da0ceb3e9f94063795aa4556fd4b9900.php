...
<div class="content">
    <div class="header">
        <h1 class="page-title">管理员修改密码</h1>
    </div>

    <div class="well">
        <!-- add form -->
        <form action="/index.php/Admin/Index/repwd/id/1" method="post" id="tab">
            <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>"></input>
            <label>用户名：</label>
            <input type="text" name='username' value="<?php echo ($data["username"]); ?>" class="input-xlarge" disabled="true"><span ><font color='red'>*用户名不准修改</font></span>
            <label>昵称</label>
            <input type="text" name="nickname" value="<?php echo ($data["nickname"]); ?>" class="input-xlarge">
            <label>请输入原始密码：</label>
            <input type="password" name="oldpwd" value="" class="input-xlarge">
            <label>请输入新密码：</label>
            <input type="password" name="password" value="" class="input-xlarge">
            <label>请确认新密码：</label>
            <input type="password" name="confpwd" value="" class="input-xlarge"><br>
