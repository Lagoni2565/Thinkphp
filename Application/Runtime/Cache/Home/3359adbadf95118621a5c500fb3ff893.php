...
<html>
	...
	<head lang="en">
		<meta charset="UTF-8">
		<title><?php echo ((isset($title) && ($title !== ""))?($title):"注册页面"); ?></title>
							...
							<div class="am-tab-panel">
								...
								<div class="login-form">
									...
									<div class="verification">
										...
										<input type="button" name="" onclick="sendmsg(this)" value="发送验证码" id="dyMobileButton" >
									</div>
	                 				<div class="user-pass">
									    <label for="password"><i class="am-icon-lock"></i></label>
									    <input type="password" name="password" id="password" placeholder="设置密码">
