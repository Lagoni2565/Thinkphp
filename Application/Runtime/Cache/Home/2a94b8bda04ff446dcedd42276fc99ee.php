					...
					<div class="area clearfix">
						<div class="category-content" id="guide_2">
							...
							<div class="category">
								...
								<!-- 遍历分类数据显示一级菜单 -->
								<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate_one): $mod = ($i % 2 );++$i; if( $cate_one["pid"] == 0 ): ?><li class="appliance js_toggle relative first">
										<div class="category-info">
											<h3 class="category-name b-category-name"><i><img src="/Public/Home/images/cake.png"></i><a class="ml-22" title="<?php echo ($cate_one["cate_name"]); ?>"><?php echo ($cate_one["cate_name"]); ?></a></h3>
											<em>&gt;</em></div>
											...
											<div class="area-in">
												<div class="area-bg">
													<div class="menu-srot">
														<div class="sort-side">
														<!-- 遍历分类数据显示二级菜单 -->
														<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate_two): $mod = ($i % 2 );++$i; if( $cate_two["pid"] == $cate_one["id"] ): ?><dl class="dl-sort">
																<dt><span title="<?php echo ($cate_two["cate_name"]); ?>"><?php echo ($cate_two["cate_name"]); ?></span></dt>
																<!-- 遍历分类数据显示三级惨淡 -->
																<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate_three): $mod = ($i % 2 );++$i; if( $cate_three["pid"] == $cate_two["id"] ): ?><dd><a title="<?php echo ($cate_three["cate_name"]); ?>" href="#"><span><?php echo ($cate_three["cate_name"]); ?></span></a></dd><?php endif; endforeach; endif; else: echo "" ;endif; ?>
									...
									<b class="arrow"></b><?php endif; endforeach; endif; else: echo "" ;endif; ?>
								</ul>
							</div>
						</div>
		...
		<div class="shopMainbg">
			<div class="shopMain" id="shopmain">
				...
				<div class="am-container ">
					<div class="shopTitle ">
						<h4><?php echo ($category_name20['cate_name']); ?></h4>
				...
				<div class="am-g am-g-fixed flood method3 ">
					...
					<?php if(is_array($cate_20)): $i = 0; $__LIST__ = $cate_20;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol_20): $mod = ($i % 2 );++$i;?><li>
							<div class="list ">
								<a href="/index.php/Home/Index/detail/id/<?php echo ($vol_20['id']); ?>">
									<img src="<?php echo ($vol_20['goods_small_img']); ?> " />
									<div class="pro-title "><?php echo ($vol_20['goods_name']); ?></div>
									<span class="e-price ">￥<?php echo ($vol_20['goods_price']); ?></span>
								</a>
							</div>
				...
				<div class="am-container ">
					<div class="shopTitle ">
						<h4><?php echo ($category_name18['cate_name']); ?></h4>
						<h3>你是我的优乐美么？不，我是你小鱼干</h3>
						<div class="today-brands ">
							<a href="# ">小鱼干</a>
							<a href="# ">海苔</a>
				...
				<div class="am-g am-g-fixed flood method3 ">
					<ul class="am-thumbnails ">
					<?php if(is_array($cate_18)): $i = 0; $__LIST__ = $cate_18;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol_18): $mod = ($i % 2 );++$i;?><li>
							<div class="list ">
								<a href="/index.php/Home/Index/detail/id/<?php echo ($vol_18['id']); ?>">
									<img src="<?php echo ($vol_18['goods_small_img']); ?> " />
									<div class="pro-title "><?php echo ($vol_18['goods_name']); ?></div>
									<span class="e-price ">￥<?php echo ($vol_18['goods_price']); ?></span>
								</a>
							</div>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				...
				<div class="am-container ">
					<div class="shopTitle ">
						<h4><?php echo ($category_name1['cate_name']); ?></h4>
						<h3>你是我的小洋妞吗？不，我是你小鱼干</h3>
						<div class="today-brands ">
							<a href="# ">小鱼干</a>
							<a href="# ">海苔</a>
							<a href="# ">鱿鱼丝</a>
				...
				<div class="am-g am-g-fixed flood method3 ">
					<ul class="am-thumbnails ">
					<?php if(is_array($cate_1)): $i = 0; $__LIST__ = $cate_1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol_1): $mod = ($i % 2 );++$i;?><li>
							<div class="list ">
								<a href="/index.php/Home/Index/detail/id/<?php echo ($vol_1['id']); ?>">
									<img src="<?php echo ($vol_1['goods_small_img']); ?> " />
									<div class="pro-title "><?php echo ($vol_1['goods_name']); ?></div>
									<span class="e-price ">￥<?php echo ($vol_1['goods_price']); ?></span>
								</a>
							</div>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
