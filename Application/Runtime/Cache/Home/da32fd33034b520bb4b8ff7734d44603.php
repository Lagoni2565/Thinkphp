		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						<a href="/index.php?m=Home&c=Login&a=login" target="_top" class="h">亲，请登录</a>
						<a href="?m=Home&c=Register&a=register" target="_top">免费注册</a>
					</div>
				</div>
			</ul>
			<ul class="message-r">
				<div class="topMessage home">
					<div class="menu-hd"><a href="?m=Home&c=Index&a=index" target="_top" class="h">商城首页</a></div>
				</div>
		...
		<div class="concent">
			...
			<div class="paycont">
				...
				<div class="logistics">
					<h3>选择支付方式</h3>
					<ul class="pay-list">
						<li class="pay card"><img src="./Public/Home/images/wangyin.jpg" />银联<span></span></li>
						<li class="pay qq"><img src="./Public/Home/images/weizhifu.jpg" />微信<span></span></li>
						<li class="pay taobao"><img src="./Public/Home/images/zhifubao.jpg" />支付宝<span></span></li>
					</ul>
				</div>
				<div class="clear"></div>
