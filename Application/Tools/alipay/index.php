...
<body>
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			<input type="text" name="WIDout_trade_no" id="out_trade_no"></div>
			<input type="text" name="WIDsubject" value="test商品123"></div>
			<input type="text" name="WIDtotal_fee" value="0.01"></div>
			<input type="text" name="WIDbody" value="即时到账测试"></div>
